//! Vectorized query VM: a small register machine that executes compiled
//! `sql_expr`-compiled queries over batches of column values (default batch
//! size 1024 rows, see [`BATCH_SIZE`]).
//!
